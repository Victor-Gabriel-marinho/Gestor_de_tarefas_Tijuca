...
function Nav() {
  ...
  return (
    <nav className="bg-[#44383e] w-screen h-10 sm:h-15 p-1 sm:p-3 justify-center items-center">
      <div className="flex w-full gap-4 p-1 justify-between items-center relative">
        ...
        >
          <div className="relative flex flex-row ">
            ...
            <span
              className=" w-[110px] absolute top-full mt-1
            text-[15px] text-gray-400
            opacity-0 group-hover:opacity-100 hover:scale-105 transition-all  duration-300
        ...
        <div className="flex gap-3 items-center">
          ...
          >
            <div className="relative flex flex-col items-center justify-center">
              ...
              <span
                className=" w-[90px] absolute top-full mt-1
              text-[15px] text-gray-400
              opacity-0 group-hover:opacity-100 hover:scale-105 transition-all  duration-300
          ...
          <div className="relative pr-3">
            ...
            >
              ...
              <span
                className=" w-[60px] absolute top-7
              text-[15px] text-gray-400
              opacity-0 group-hover:opacity-100 hover:scale-105 transition-all duration-300
              pointer-events-none bg-[#1f1a1a] p-0.5 rounded-[5px] text-center z-50 "
              >
