...
function PopUp ({popUp, setpopUp, ClassName="", ...Props}: PopUpProps) {
    return (
        <div {...Props} className={` w-[122px] h-[133px] flex flex-col items-center justify-center rounded-[15px] ${ClassName} top-0 right-1/12 absolute` }>
            ...
            <div className="flex flex-col gap-4 items-center">
                <p className=" font-semibold cursor-pointer">Gestor</p>
                <div className="w-full h-0.5 bg-white"></div>
                <p className=" font-semibold cursor-pointer">Colaborador</p>
            </div>
        </div>
    )
}
