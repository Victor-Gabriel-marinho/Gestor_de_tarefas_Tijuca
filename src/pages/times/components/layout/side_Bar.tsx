  ...
  return (
    <div className="h-13 sm:h-full w-full sm:w-60 bg-[#251F1F] justify-center sm:justify-start items-center fixed sm:static bottom-0 z-10 flex flex-row sm:flex-col gap-10 sm:gap-3 sm:pt-10">
      ...
      >
        ...
        {!hiddenteams && (
          <div className="flex max-h-80 overflow-y-auto w-55 sm:w-full absolute sm:static bg-zinc-900 sm:bg-[#251F1F] rounded-xl sm:rounded-none left-5 bottom-full sm:bottom-0 z-50 sm:z-0 flex-col gap-4 sm:gap-7 ">
            {loading ? (
              <Loading_anim />
            ) : (
              Teams.map((team: Team) => (
