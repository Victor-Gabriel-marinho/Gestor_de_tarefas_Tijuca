            ...
            <div className="bg-[#1F2937] w-screen h-screen overflow-hidden">
               ...
               <main >
                    ...
                    <div className="w-full h-50 relative flex flex-row m-5 gap-5">
                      ...
                      <Link to="/lista" className="">
                        
                         <div className="w-40 h-40 bg-white rounded-2xl hover:scale-110 flex items-baseline-last">
    
                        
                         <div className="bg-[#251F1F] w-40 rounded-[5px] p-3">
